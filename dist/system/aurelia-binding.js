...
System.register(['aurelia-logging', 'aurelia-pal', 'aurelia-task-queue', 'aurelia-metadata'], function (_export, _context) {
  ...
  var LogManager, PLATFORM, DOM, TaskQueue, metadata, _createClass, _typeof, _dec, _dec2, _class, _dec3, _class2, _dec4, _class3, _dec5, _class5, _dec6, _class7, _dec7, _class8, _dec8, _class9, _dec9, _class10, _class12, _temp, _dec10, _class13, _class14, _temp2, targetContext, sourceContext, map, slotNames, versionSlotNames, lastSlot, queue, queued, nextId, minimumImmediate, frameBudget, isFlushRequested, immediate, arrayPool1, arrayPool2, poolUtilization, ExpressionObserver, EDIT_LEAVE, EDIT_UPDATE, EDIT_ADD, EDIT_DELETE, arraySplice, ModifyCollectionObserver, CollectionLengthObserver, arrayProto, pop, push, reverse, shift, sort, splice, unshift, ModifyArrayObserver, Expression, BindingBehavior, ValueConverter, Assign, Conditional, AccessThis, AccessScope, AccessMember, AccessKeyed, CallScope, CallMember, CallFunction, Binary, Unary, LiteralPrimitive, LiteralString, LiteralTemplate, LiteralArray, LiteralObject, _Unparser, ExpressionCloner, bindingMode, Parser, fromCharCode, ParserImplementation, C$This, C$Scope, C$Member, C$Keyed, C$Call, C$Primary, C$ShorthandProp, C$Tagged, C$Ancestor, T$TokenMask, T$PrecShift, T$Precedence, T$ExpressionTerminal, T$ClosingToken, T$OpeningToken, T$AccessScopeTerminal, T$Keyword, T$EOF, T$Identifier, T$IdentifierOrKeyword, T$Literal, T$NumericLiteral, T$StringLiteral, T$BinaryOp, T$UnaryOp, T$MemberExpression, T$MemberOrCallExpression, T$TemplateTail, T$TemplateContinuation, T$FalseKeyword, T$TrueKeyword, T$NullKeyword, T$UndefinedKeyword, T$ThisScope, T$ParentScope, T$LParen, T$LBrace, T$Period, T$RBrace, T$RParen, T$Comma, T$LBracket, T$RBracket, T$Colon, T$Question, T$Ampersand, T$Bar, T$BarBar, T$AmpersandAmpersand, T$Caret, T$EqEq, T$BangEq, T$EqEqEq, T$BangEqEq, T$Lt, T$Gt, T$LtEq, T$GtEq, T$InKeyword, T$InstanceOfKeyword, T$Plus, T$Minus, T$TypeofKeyword, T$VoidKeyword, T$Star, T$Percent, T$Slash, T$Eq, T$Bang, KeywordLookup, TokenValues, codes, AsciiIdParts, IdParts, CharScanners, ci, mapProto, ModifyMapObserver, emLogger, CapturedHandlerEntry, DelegateHandlerEntry, DelegationEntryHandler, EventHandler, DefaultEventStrategy, delegationStrategy, EventManager, EventSubscriber, DirtyChecker, DirtyCheckProperty, logger, propertyAccessor, PrimitiveObserver, SetterObserver, XLinkAttributeObserver, dataAttributeAccessor, DataAttributeObserver, StyleObserver, ValueAttributeObserver, checkedArrayContext, checkedValueContext, CheckedObserver, selectArrayContext, SelectValueObserver, ClassObserver, ComputedExpression, svgElements, svgPresentationElements, svgPresentationAttributes, svgAnalyzer, createElement, elements, presentationElements, presentationAttributes, SVGAnalyzer, ObserverLocator, ObjectObservationAdapter, BindingExpression, Binding, CallExpression, Call, ValueConverterResource, BindingBehaviorResource, ListenerExpression, Listener, NameExpression, NameBinder, LookupFunctions, BindingEngine, setProto, ModifySetObserver, signals;
  ...
  _export('connectBindingToSignal', connectBindingToSignal);
  ...
  _export('signalBindings', signalBindings);
  ...
  return {
    ...
    execute: function () {
      ...
      _export('BindingBehavior', BindingBehavior = function (_Expression) {
      ...
      _export('ValueConverter', ValueConverter = function (_Expression2) {
      ...
      _export('Assign', Assign = function (_Expression3) {
      ...
      _export('Conditional', Conditional = function (_Expression4) {
      ...
      _export('AccessThis', AccessThis = function (_Expression5) {
      ...
      _export('AccessScope', AccessScope = function (_Expression6) {
      ...
      _export('AccessMember', AccessMember = function (_Expression7) {
      ...
      _export('AccessKeyed', AccessKeyed = function (_Expression8) {
      ...
      _export('CallScope', CallScope = function (_Expression9) {
      ...
      _export('CallMember', CallMember = function (_Expression10) {
      ...
      _export('CallFunction', CallFunction = function (_Expression11) {
      ...
      _export('Binary', Binary = function (_Expression12) {
      ...
      _export('Unary', Unary = function (_Expression13) {
      ...
      _export('LiteralPrimitive', LiteralPrimitive = function (_Expression14) {
      ...
      _export('LiteralString', LiteralString = function (_Expression15) {
      ...
      _export('LiteralTemplate', LiteralTemplate = function (_Expression16) {
      ...
      _export('LiteralTemplate', LiteralTemplate);
      ...
      T$TokenMask = (1 << 6) - 1;
      T$PrecShift = 6;
      T$Precedence = 7 << T$PrecShift;
      T$ExpressionTerminal = 1 << 11;
      T$ClosingToken = 1 << 12;
      T$OpeningToken = 1 << 13;
      T$AccessScopeTerminal = 1 << 14;
      T$Keyword = 1 << 15;
      T$EOF = 1 << 16 | T$AccessScopeTerminal | T$ExpressionTerminal;
      T$Identifier = 1 << 17;
      T$IdentifierOrKeyword = T$Identifier | T$Keyword;
      T$Literal = 1 << 18;
      T$NumericLiteral = 1 << 19 | T$Literal;
      T$StringLiteral = 1 << 20 | T$Literal;
      T$BinaryOp = 1 << 21;
      T$UnaryOp = 1 << 22;
      T$MemberExpression = 1 << 23;
      T$MemberOrCallExpression = 1 << 24;
      T$TemplateTail = 1 << 25 | T$MemberOrCallExpression;
      T$TemplateContinuation = 1 << 26 | T$MemberOrCallExpression;
      T$FalseKeyword = 0 | T$Keyword | T$Literal;
      T$TrueKeyword = 1 | T$Keyword | T$Literal;
      T$NullKeyword = 2 | T$Keyword | T$Literal;
      T$UndefinedKeyword = 3 | T$Keyword | T$Literal;
      T$ThisScope = 4 | T$IdentifierOrKeyword;
      T$ParentScope = 5 | T$IdentifierOrKeyword;
      T$LParen = 6 | T$OpeningToken | T$AccessScopeTerminal | T$MemberOrCallExpression;
      T$LBrace = 7 | T$OpeningToken;
      T$Period = 8 | T$MemberExpression | T$MemberOrCallExpression;
      T$RBrace = 9 | T$AccessScopeTerminal | T$ClosingToken | T$ExpressionTerminal;
      T$RParen = 10 | T$AccessScopeTerminal | T$ClosingToken | T$ExpressionTerminal;
      T$Comma = 11 | T$AccessScopeTerminal;
      T$LBracket = 12 | T$OpeningToken | T$AccessScopeTerminal | T$MemberExpression | T$MemberOrCallExpression;
      T$RBracket = 13 | T$ClosingToken | T$ExpressionTerminal;
      T$Colon = 14 | T$AccessScopeTerminal;
      T$Question = 15;
      T$Ampersand = 18 | T$AccessScopeTerminal;
      T$Bar = 19 | T$AccessScopeTerminal;
      T$BarBar = 20 | 1 << T$PrecShift | T$BinaryOp;
      T$AmpersandAmpersand = 21 | 2 << T$PrecShift | T$BinaryOp;
      T$Caret = 22 | 3 << T$PrecShift | T$BinaryOp;
      T$EqEq = 23 | 4 << T$PrecShift | T$BinaryOp;
      T$BangEq = 24 | 4 << T$PrecShift | T$BinaryOp;
      T$EqEqEq = 25 | 4 << T$PrecShift | T$BinaryOp;
      T$BangEqEq = 26 | 4 << T$PrecShift | T$BinaryOp;
      T$Lt = 27 | 5 << T$PrecShift | T$BinaryOp;
      T$Gt = 28 | 5 << T$PrecShift | T$BinaryOp;
      T$LtEq = 29 | 5 << T$PrecShift | T$BinaryOp;
      T$GtEq = 30 | 5 << T$PrecShift | T$BinaryOp;
      T$InKeyword = 31 | 5 << T$PrecShift | T$BinaryOp | T$Keyword;
      T$InstanceOfKeyword = 32 | 5 << T$PrecShift | T$BinaryOp | T$Keyword;
      T$Plus = 33 | 6 << T$PrecShift | T$BinaryOp | T$UnaryOp;
      T$Minus = 34 | 6 << T$PrecShift | T$BinaryOp | T$UnaryOp;
      T$TypeofKeyword = 35 | T$UnaryOp | T$Keyword;
      T$VoidKeyword = 36 | T$UnaryOp | T$Keyword;
      T$Star = 37 | 7 << T$PrecShift | T$BinaryOp;
      T$Percent = 38 | 7 << T$PrecShift | T$BinaryOp;
      T$Slash = 39 | 7 << T$PrecShift | T$BinaryOp;
      T$Eq = 40;
      T$Bang = 41 | T$UnaryOp;
      ...
      TokenValues = [false, true, null, undefined, '$this', '$parent', '(', '{', '.', '}', ')', ',', '[', ']', ':', '?', '\'', '"', '&', '|', '||', '&&', '^', '==', '!=', '===', '!==', '<', '>', '<=', '>=', 'in', 'instanceof', '+', '-', 'typeof', 'void', '*', '%', '/', '=', '!'];
      codes = {
      ...
      AsciiIdParts = new Set();

      decompress(null, AsciiIdParts, codes.AsciiIdPart, true);

      IdParts = new Uint8Array(0xFFFF);
      ...
      emLogger = LogManager.getLogger('event-manager');
      ...
      DelegationEntryHandler = function () {
      ...
      _export('EventSubscriber', EventSubscriber = function () {
      ...
      _export('EventSubscriber', EventSubscriber);
